                        ...
                        <div className="col-10 mx-auto">
                            <div className="row">
                                <div className="col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 ">
                                    <h1 className='pt-3 h1'>Welcome to About Page</h1>
                                    <h3 className="my-4">This is the about page of the very website using React  , The renounded Library of JavaScript..</h3>
